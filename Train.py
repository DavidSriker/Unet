...
if __name__ == "__main__":
    ...
    if opt.dataset_name == 'lung':
        ...
        if os.path.exists(os.path.join(lung_path, "split")):
            ...
            test_img.to_pickle(os.path.join(lung_path, "split", "test_seg.pkl"))
    ...
    unet = TrainerUnet((1, *image_shape), opt)
    unet.train(train_loader, val_loader, data_name=opt.dataset_name)
